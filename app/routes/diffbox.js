...
//             <BlockStack  gap="200">
//               <div className="Polaris-BlockStack" style={{ 'gap': '20px' }}>

//                   <Card style={{ 'width': '50%' }}>
//                     <div className="Polaris-BlockStack" style={{ 'width': "100%", '--pc-block-stack-order':'column' , '--pc-block-stack-gap-xs': 'var(--p-space-200)' }} >
...
//                   </Card>
//                   <Card>
//                   <div className="Polaris-BlockStack"  style={{ '--pc-block-stack-order':'column' , '--pc-block-stack-gap-xs': 'var(--p-space-200)' }}>
//                     <h2 class="Polaris-Text--root Polaris-Text--headingMd"  style={{ 'fontSize': '16px', 'marginBottom': '2px' }}>Online store dashboard</h2>
